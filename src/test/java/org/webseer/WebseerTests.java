...
public class WebseerTests extends TestCase {
	...
	private static final String GENERATE_MULTI_FUNCTION = "package org.webseer; import org.webseer.java.JavaFunction; import org.webseer.transformation.OutputChannel; import java.util.List; import java.util.Arrays; public class GenerateMultiFunction implements JavaFunction { @OutputChannel public List<String> generatedStrings; public void execute() { generatedStrings = Arrays.asList(\"AAAAAAAAAA\", \"BBBBBBBBBB\", \"CCCCCCCCCC\"); }}";

	private static final String TIME_FUNCTION = "package org.webseer; import org.webseer.java.JavaFunction; import org.webseer.transformation.OutputChannel; public class TimeFunction implements JavaFunction { @OutputChannel public Long currentTime; public void execute() { currentTime = System.currentTimeMillis();}}";

	private static final String GENERATE_FUNCTION = "package org.webseer; import org.webseer.java.JavaFunction; import org.webseer.transformation.OutputChannel; public class GenerateFunction implements JavaFunction { @OutputChannel public String generatedString; public void execute() { generatedString = String.valueOf(\"String from time \" + System.currentTimeMillis());}}";

	private static final String OUTPUTS_FUNCTION = "package org.webseer; import org.webseer.java.JavaFunction; import org.webseer.transformation.OutputChannel; public class OutputsFunction implements JavaFunction { @OutputChannel public String firstString; @OutputChannel public String secondString; public void execute() { firstString = String.valueOf(\"First string from time \" + System.currentTimeMillis()); secondString = String.valueOf(\"Second string from time \" + System.currentTimeMillis());}}";

	private static final String CONVERT_FUNCTION = "package org.webseer; import org.webseer.java.JavaFunction; import org.webseer.transformation.OutputChannel; import org.webseer.transformation.InputChannel; public class ConvertFunction implements JavaFunction { @InputChannel public String toConvert; @OutputChannel public String convertedString; public void execute() { convertedString = toConvert.substring(0, 6); }}";

	private static final String COUNT_FUNCTION = "package org.webseer; import org.webseer.java.JavaFunction; import org.webseer.transformation.OutputChannel; import org.webseer.transformation.InputChannel; public class CountFunction implements JavaFunction { @InputChannel public Iterable<String> toCount; @OutputChannel public int count; public void execute() { count = 0; for (String item : toCount) { count++; } }}";
